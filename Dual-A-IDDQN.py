...
CSV_PATH = Path(
    "AttentionDualSensorFusionResults/dual_sensor_comparison_metrics_A-IDDQN.csv")
EPISODE_REWARD_CSV_PATH = Path(
    "AttentionDualSensorFusionResults/dual_sensor_episode_rewards_A-IDDQN.csv")
PLOT_PATH = Path(
    "AttentionDualSensorFusionResults/dual_sensor_paths_A-IDDQN.png")
REWARD_PLOT_PATH = Path(
    "AttentionDualSensorFusionResults/dual_sensor_reward_curves_A-IDDQN.png")
BAR_PATH = Path(
    "AttentionDualSensorFusionResults/dual_sensor_metric_bars_A-IDDQN.png")
CHECKPOINT_DIR = Path(
    "AttentionDualSensorFusionResults/dual_sensor_rl_checkpoints_A-IDDQN")
